...
from model.models_multicapa import cloudCPA
...
def main():
    ...
    parser.add_argument("--model_name", type=str, default='210_31.3716_0.9242', help='model name')
    # test
    ...
    G_Model, _, _ = load_checkpoint(argspar.model, cloudCPA, Gmodel_name)
