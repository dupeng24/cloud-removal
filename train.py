...
from dataHa_name.makedataset import Dataset
from utils import adjust_learning_rate, load_checkpoint, tensor_metric, save_checkpoint, tensor2cuda, load_excel,load_checkpoint1,load_excel1
import matplotlib.pyplot as plt
from model.loss import msssim
from model.models_multicapa import cloudCPA,Discriminator
...
def main():
    ...
    parser.add_argument("--data", type=str, default="./dataHa_name/halpha_allcloud122.h5", help='data')
    # value
    ...
    G_Model, G_optimizer, cur_epoch = load_checkpoint(argspar.model, cloudCPA, Gmodel_name)
